...
class AlbumForm(FlaskForm):
    ...
    description = StringField('Description', validators=[DataRequired("Please add a description"), Length(min=1, max=40, message="Title must be between 1 and 40 characters long.")])
