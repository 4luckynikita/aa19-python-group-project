from app.models import db, Album, Musician, environment, SCHEMA
...
def seed_albums():
    ...
    the_dark_side_of_the_moon = Album(
        musician_id=Musician.query.filter_by(name="Pink Floyd").first().id,
    ...
    a_night_at_the_opera = Album(
        musician_id=Musician.query.filter_by(name="Queen").first().id,
    ...
    nevermind = Album(
        musician_id=Musician.query.filter_by(name="Nirvana").first().id,
        title="Nevermind",
    ...
    master_of_puppets = Album(
        musician_id=Musician.query.filter_by(name="Metallica").first().id,
    ...
    let_it_bleed = Album(
        musician_id=Musician.query.filter_by(name="The Rolling Stones").first().id,
        title="Let It Bleed",
    ...
    ok_computer = Album(
        musician_id=Musician.query.filter_by(name="Radiohead").first().id,
        title="OK Computer",
    ...
    led_zeppelin_iv = Album(
        musician_id=Musician.query.filter_by(name="Led Zeppelin").first().id,
    ...
    london_calling = Album(
        musician_id=Musician.query.filter_by(name="The Clash").first().id,
    ...
    the_joshua_tree = Album(
        musician_id=Musician.query.filter_by(name="U2").first().id,
    ...
    californication = Album(
        musician_id=Musician.query.filter_by(name="Red Hot Chili Peppers").first().id,
